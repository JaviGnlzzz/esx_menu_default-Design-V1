...
(function(){
	let MenuTpl =
		...
		'<div class="head"><div class="headtitle">Nombre de tu server</div></div>' +
		'<div class ="pos"><hr></div>'+
				'<div class="menu-items">' + 
							'{{#elements}}' +
							'<div class="menu-item {{#selected}}selected{{/selected}}">' +
								'<span id="icono" class="fa-solid fa-circle-right"> </span>{{{label}}}{{#isSlider}} : &lt;{{{sliderLabel}}}&gt;{{/isSlider}}' +
							'</div>' +
						'{{/elements}}' +
					'<div class="footer-items"' +
					'<p>'+				
					'<button id="boton2" class="boton3"><i class="fa-solid fa-circle-arrow-up"></i> Aceptar</i></button>'+
					'<button id="boton1" class="boton2"><i class="fa-solid fa-circle-arrow-left"></i> Salir</button>'+						
					'</p>'+
